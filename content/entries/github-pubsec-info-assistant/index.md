---
slug: github-pubsec-info-assistant
id: github-pubsec-info-assistant
title: Building ChatGPT-like Experiences with Azure OpenAI
repo: justin-napolitano/PubSec-Info-Assistant
githubUrl: 'https://github.com/justin-napolitano/PubSec-Info-Assistant'
generatedAt: '2025-11-24T21:36:01.209Z'
source: github-auto
summary: >-
  Learn how to create ChatGPT-like applications using Azure OpenAI Service and
  Cognitive Search with the IA Accelerator.
tags:
  - azure
  - openai
  - cognitive search
...
seoPrimaryKeyword: chatgpt azure openai integration
seoSecondaryKeywords:
  - azure cognitive search tutorial
  - deploying chatgpt applications
